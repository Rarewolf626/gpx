<?php
/**
 * Template Name: Booking Path Confirmation Page
 * Theme: GPX
 */
    ...
    <div class="w-featured bg-gray-light w-result-home">
        ...
        <div class="w-list-view dgt-container">
            <div class="confirm">
                ...
                <div class="cnt right">
                    <a href=""><span>Print </span> <i class="print"></i></a> | <a href=""><span> Email</span> <i class="mail"></i></a>
                </div>
            </div>
                    ...
                    <div class="view-cnt">
                        <div class="descrip">
                            <hgroup>
                                ...
                                <br>
                                <span><strong>Resort ID:</strong> R-17008</span>
                            </hgroup>
                            <p>1234 Oaklong Way, Queensland 2428, Australia</p>
                            <p>Assistance? Email: <a href="" mailto:"gpx@gpresorts.com">gpx@gpresorts.com</a> <a href="teL:866.325.6295"></a>Call: 866.325.6295</p>
                        </div>
                        <div class="w-status">
                            <a href="" class="dgt-btn view">View Resort Profile</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-profile">
                <div class="gateway">
                    <p>Reference Number: 338155 Payment Gateway Ref.: 0405191633224949:YYYM</p>
                </div>
                <div class="list">
                    <div class="item">
                        <ul>
                            <li>
                                ...
                                <p><strong>234766</strong></p>
                            </li>
                            <li>
                                <p>Member:</p>
                                <p><strong>Todd Skelton</strong></p>
                            </li>
                            <li>
                                <p>Arriving Guest(s):</p>
                                <p><strong>Michael Smith</strong></p>
                                <p><strong>1 Adults, 2 Children</strong></p>
                            </li>
                            <li>
                                <p>CPO Option:</p>
                    ...
                    <div class="item last">
                        <ul>
                            ...
                            <li>
                                <div>
                                    <p>CPO Cancellation Insurance</p>
                ...
                <div class="w-form">
                    <form action="" class="material">
                        ...
                        <div class="gform_footer">
                            ...
                            <a href="<?php echo site_url(); ?>/booking-path-exchange/" class="dgt-btn" id="next-2" data-id="booking-3">Next</a>
                        </div>
                    </form>
                </div>
            </div>
