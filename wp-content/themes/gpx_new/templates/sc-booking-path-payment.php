...
<?php else: ?>
    ...
    <section class="w-banner w-results w-results-home">
        <ul id="slider-home"
            class="royalSlider heroSlider rsMinW rsFullScreen rsFullScreen-result rs-col-3 booking-path">
                    ...
                    <div class="w-item-view filtered">
                        ...
                        <div class="view-detail">
                            <ul class="list-result">
                                    ...
                                    <p>
                                        ...
                                        if (empty($spOut[$propKey])) {
                                            ...
                                            if (!empty($prop->specialIcon) || !empty($prop->slash)) {
                                                ...
                                                ?>
                                                <span
                                                    style="text-deocoration: line-through;"><?= $nopriceint . $prop->WeekPrice ?></span>
                                                <?php
                                            }
                                    ...
                                    <li>
                                        ...
                                        <p>
                                            ...
                                            if (isset($indCPOFee[$propKey])) {
                                                ?>
                                                <a href="#" class="removeIndCPO" title="Remove Flex Booking"
                                                   data-cid="<?= $cid ?>" data-cartID="<?= $_COOKIE['gpx-cart'] ?>"
                                                   data-propID="<?= $propKey ?>"><strong>remove</strong></a>
                                                <?php
                                                if (isset($indCPOSlash[$propKey]) && !empty($indCPOSlash[$propKey])) {
                                                    ?>
                                                    <span
                                                        style="text-deocoration: line-through;">$<?= number_format($indCPOSlash[$propKey], 0) ?></span>
                                                    <?php
                                                }
                                                ?>
                                        ...
                                        <div class="result">
                                            ...
                                            <p>
                                                ...
                                                if (isset($indUpgradeFeeSlash[$propKey]) && !empty($indUpgradeFeeSlash[$propKey])) {
                                                    ?>
                                                    <span
                                                        style="text-deocoration: line-through;">$<?= number_format($indUpgradeFeeSlash[$propKey], 0) ?></span>
                                                    <?php
                                                }
                                                ?>
                                        ...
                                        <div class="result">
                                            ...
                                            <p>
                                                ...
                                                if (isset($indGFSlash[$propKey])) {
                                                    ?>
                                                    <span
                                                        style="text-deocoration: line-through;">$<?= number_format($indGFSlash[$propKey], 0) ?></span>
                                                    <?php
                                                }
                                                ?>
                                ...
                                <?php } ?>
                                <?php if ($prop->ResortFeeSettings['total'] > 0): ?>
                                    <li>
                                        <p><strong>Required Resort Fees</strong><br><em style="font-size:14px;">Payable at the Resort</em></p>
                                        <p><?= gpx_currency($prop->ResortFeeSettings['total'], true) ?></p>
                                    </li>
                                <?php endif; ?>
                                <li style="border-top:solid 1px #000;padding-top:10px;">
                                    <p><strong>Total</strong></p>
                                    <p style="font-weight:bold;font-size:120%;"><?= gpx_currency($prop->subtotal, true) ?></p>
                                </li>
...
//                     $holddate = strtotime($limithold->release_on.' +'.get_option('gpx_hold_limt_time').' hours');
                            ...
                            <div class="inlinebox">
                                <div class="gwrapper">
                                    <div class="ginput_container">
                                        <input type="text" id="couponCode" name="couponCode" data-book="<?= $book ?>"
                                               data-cid="<?= $cid ?>" data-cartID="<?= $_COOKIE['gpx-cart'] ?>"
                                               data-currentPrice="<?= array_sum($indPrice) - $taxTotal ?>"
                                               placeholder="Enter a Coupon Code" value="">
                                    </div>
                                    <div class="ginput_container">
                            ...
                            <div class="carts <?= $zeroDue; ?>">
                                ...
                                <form action="" id="paymentForm" class="material paymentForm">
                                    <?php foreach ($props as $propKey => $prop): ?>
                                        <input type="hidden" name="fullPrice[<?= $propKey ?>]"
                                               value="<?= $fullPrice[$propKey] ?? '' ?>">
                                        <input type="hidden" name="pp[<?= $propKey ?>]"
                                               value="<?= $indPrice[$propKey] ?? '' ?>">
                                        <input type="hidden" name="CPOFee[<?= $propKey ?>]"
                                               value="<?= $indCPOFee[$propKey] ?? '' ?>">
                                        <input type="hidden" name="extensionFee[<?= $propKey ?>]"
                                               value="<?= $indExtFee[$propKey] ?? '' ?>">
                                        <input type="hidden" name="CPO[<?= $propKey ?>]"
                                               value="<?= $CPO[$propKey] ?? '' ?>">
                                    <?php endforeach; ?>
                                    ...
                                    if (!empty($LateDepositFeeAmount)) {
                                        ?>
                                        <input type="hidden" name="LateDepositFeeAmount"
                                               value="<?= $LateDepositFeeAmount ?>">
                                        <?php
                                    }
                                    ?>
                                    ...
                                    if (!empty($indCartOCCreditUsed)) {
                                        ?>
                                        <input type="hidden" name="ownerCreditCoupon"
                                               value="<?= array_sum($indCartOCCreditUsed) ?>">
                                        <?php
                                    }
                                    ?>
                                    <ul>
                                        <li><img src="<?php echo get_template_directory_uri(); ?>/images/payment.png"
                                                 alt="logo" width="" height=""></li>
                                        <li>
                                            <div class="ginput_container">
                                                <input type="text" placeholder="Street Address *" name="billing_address"
                                                       id="billing_address" autocomplete="off" required>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="ginput_container">
                                                <input type="text" placeholder="City *" name="billing_city"
                                                       id="billing_city" autocomplete="off" required>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="ginput_container">
                                                <input type="text" placeholder="State *" name="billing_state" id="c"
                                                       autocomplete="off" required>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="ginput_container">
                                                <input type="text" placeholder="Post / Zip Code *" name="billing_zip"
                                                       id="billing_zip" autocomplete="off" required>
                                            </div>
                                        </li>
                                        <li>
                                            <?php
                                        ...
                                        <li>
                                            <div class="ginput_container">
                                                <input type="text" placeholder="Email *" name="billing_email"
                                                       id="billing_email" autocomplete="off" required>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="ginput_container">
                                                <input type="text" placeholder="Cardholder Name"
                                                       name="billing_cardholder" id="billing_cardholder"
                                                       autocomplete="off" required>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="ginput_container">
                                                <input type="text" placeholder="Cardholder Number *"
                                                       name="billing_number" id="billing_number" autocomplete="off"
                                                       required>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="ginput_container">
                                                <input type="text" placeholder="CVV *" name="billing_ccv"
                                                       autocomplete="off" required>
                                            </div>
                                        </li>
                                        <li>
                        ...
                        <ul class="w-list-details">
                                        ...
                                        if (isset($prop->Price) && $prop->Price > 0) {
                                            if (!empty($spSum) && $ppSum != $spSum) {
                                                ...
                                                if ($addPromoSlash) {
                                                    ...
                                                    ?>
                                                    <span
                                                        style="text-deocoration: line-through;"><?= $nopriceint . number_format($ppSum, 2) ?></span>
                                                    <?php
                                                }
                            ...
                            if (isset($totalCPOFee) and $totalCPOFee > 0 and isset($prop->WeekType) and $prop->WeekType == 'Exchange Week') {
                                ...
                                <li>
                                    <div class="result">
                                        <p>
                                            <a href="#" id="removeCPO" title="Remove Flex Booking"
                                               data-cid="<?= $cid ?>" data-cartID="<?= $_COOKIE['gpx-cart'] ?>"><strong>remove</strong></a>
                                            Flex Booking
                                            <?php
                                            if (isset($totalCPOSlash) && !empty($totalCPOSlash)) {
                                                ?>
                                                <span
                                                    style="text-deocoration: line-through;">$<?= $totalCPOSlash ?></span>
                                                <?php
                                            }
                                            ?>
                                            $<?= number_format($totalCPOFee, 2) ?>
                                            <a href="#" class="data-modal" aria-label="tooltip" data-html="#flexbooking"
                                               data-text="GPR members can choose the Flex Booking at the time of accepting an exchange offer upon payment of the current Flex Booking costs. Flex Booking only applies to exchange transactions. The unit-size upgrade fee refund is included in the standard Flex Booking available on exchange transactions. Should Flex Booking be accepted and a GPR member requests cancellation of the confirmed exchange, the member must cancel it no later than 45 days prior to the check-in date and time of that exchange reservation confirmation for the cancellation to be valid. The GPR member will then have until the earlier of (1) the expiration of the original exchange credit or (2) 24 months from the date of cancellation to make a Replacement Exchange. There is no cost to make a replacement exchange. The GPR member will have the option of electing to obtain a new Flex Booking on any replacement exchange upon payment of the then-current Flex Booking costs. No monetary refunds are allowed on cancellations regardless of whether a Flex Booking has been obtained."><i
                                                    class="fa fa-question-circle" aria-hidden="true"></i></a>
                                    ...
                                    <div class="result">
                                        <p>Upgrade Fee
                                            ...
                                            if (isset($upgradeSlash) && !empty($upgradeSlash)) {
                                                ?>
                                                <span
                                                    style="text-deocoration: line-through;">$<?= $upgradeSlash ?></span>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <div class="result">
                                        <p>Credit Extension Fee
                                            ...
                                            if (isset($extensionSlash) && !empty($extensionSlash)) {
                                                ?>
                                                <span
                                                    style="text-deocoration: line-through;">$<?= $extensionSlash ?></span>
                                                <?php
                                            }
                                            ?>
                            ...
                            if (!empty($couponDiscount)) {
                                ...
                                <li>
                                    <div class="result">
                                        <p>
                                            Discount: <?= $couponDiscount ?> <i class="fa fa-times-circle"
                                                                                id="removeCoupon" aria-hidden="true"
                                                                                title="Remove Discount"
                                                                                data-cid="<?= $cid ?>"
                                                                                data-cartID="<?= $_COOKIE['gpx-cart'] ?>"></i>
                                        </p>
                                    </div>
                                </li>
                                <?php
                            ...
                            if (!empty($indCartOCCreditUsed)) {
                                ...
                                <li>
                                    <div class="result">
                                        <p>
                                            Credit
                                            Used: <?= $nopriceint . number_format(array_sum($indCartOCCreditUsed), 2) ?>
                                            <i class="fa fa-times-circle" id="removeOwnerCreditCoupon"
                                               aria-hidden="true" title="Remove Credit" data-type="occoupon"></i>
                                        </p>
                                    </div>
                                </li>
                                <?php
                            ...
                            ?>
                            <?php if (isset($resortFee) && $resortFee > 0): ?>
                                <li>
                                    <div class="result">
                                        <p style="margin-bottom:0;">
                                        Required Resort Fees: <?= gpx_currency($resortFee) ?>
                                        </p>
                            ...
                            <li>
                                <div class="result">
                                    <p>
                                        <?php $ocdiscount = !empty($indCartOCCreditUsed) ? array_sum($indCartOCCreditUsed) : 0; ?>
                                        <?php $discount = (float)str_replace('$', '', $couponDiscount ?? 0); ?>
                                        Total: <?= gpx_currency($resortFee + (float)($price ?? 0) + (float)($taxTotal ?? 0) + (float)($LateDepositFeeAmount ?? 0) + (float)($totalCPOFee ?? 0) + (float)($GuestFeeAmount ?? 0) + (float)($extensionFee ?? 0) + (float)($upgradeFee ?? 0) - $discount - $ocdiscount) ?>
                                    </p>
                                </div>
                            </li>
                            <?php if (isset($resortFee) && $resortFee > 0): ?>
                            ...
                            <li>
                                <div class="message">
                                    <?php if (Arr::first($props)->WeekType != 'Exchange Week'): ?>
                                        <p style="text-align:center;"> Sales Taxes included.</p>
                                    <?php endif; ?>
                                </div>
                            </li>
                            <li>
                                <div class="message">
                                    <p>This charge will show on your credit card statement as <strong>Grand Pacific
                                            Exchange</strong></p>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="payconfirm">
                    <div class="check">
                        ...
                        <div class="cnt">
                            <a href="<?php echo site_url(); ?>/booking-path-confirmation/"
                               class="dgt-btn btn-next submit-payment" id="next-3" data-id="booking-4">Pay & Confirm</a>
                        </div>
                    </div>
                    <p>
                        <?php
    ...
    <div id="flexbooking" style="display: none;">
        <p>Grand Pacific Exchange offers the option of purchasing Flex Booking for an additional fee of $<?= $fbFee ?>
            paid
            concurrently when booking an Exchange provided that the Exchange is made more than 45 days from the Check-In
            Date.
            If purchased, Flex Booking covers you in the event you are not able to utilize your reserved vacation and
            need to
            request cancellation of your Exchange. Provided your cancellation is submitted more than forty-five (45)
            days prior
            to the Confirmed Exchange Check-In date, under Flex Booking (i) the original Exchange Credit will be
            returned to the
            your GPX Account and will expire two (2) years from the original Exchange Credit start date; and (ii) the
            Exchange and
            any Upgrade Fees paid for the Confirmed Exchange will be refunded in the form of a coupon code valid for one
            year that
            may be applied towards your next Exchange or Rental Booking. If at the time of the new booking, the cost
            exceeds the
            amount of the coupon code, the GPX Member must pay the incremental increase. Flex Booking may be purchased
            for any Exchange.
            No monetary refunds are distributed for cancellations at any time.</p>
        <p>Flex Booking cannot be used to cancel a Confirmed Exchange and then re-book the same Resort Week as either a
            Rental Week or
            Additional Benefit.</p>
        <p>Flex Booking is optional. Members who decline Flex Booking in connection with a Confirmed Exchange will
            forfeit their Exchange
            Fee upon cancellation of a Confirmed Exchange, which includes any change in dates, unit type, vacation area
            or Resorts. Flex
