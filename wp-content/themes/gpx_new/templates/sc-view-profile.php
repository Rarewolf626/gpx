...
//             			}
            ...
            ?>
            	<div class="form">
            		<form action="" id="newpwform" class="material" data-cid="<?=$cid?>">
            			...
            			?>
            			<div class="gpinput">
            				<input type="password" id="chPassword" name="chPassword" class="successclear" placeholder="Type new password" autocomplete="off" required >
            			</div>
            			<div class="gpinput">
            				<input type="password" id="chPasswordConfirm" class="successclear" name="chPasswordConfirm" placeholder="Confirm new password"  autocomplete="off" required >
            			</div>
            			<div class="gpinput">
        ...
        <div id="history-profile" class="w-information">
            ...
            <div class="content content-table transaction-load" data-load="load_transactions" data-id="<?=$cid?>" data-type="transactions">
                <div class="loading">
                	<i class="fa fa-refresh fa-spin fa-3x fa-fw"></i>
        			<span class="sr-only">Loading...</span>
    			</div>
            ...
            <div class="content content-table">
            		<table class="data-table">
            			...
            			<tbody>
            				...
            				?>
            				<tr>
            					<td><a href="/promotion/<?=$coupon['slug']?>"><?=$coupon['name']?> <i class="fa fa-link"></i></a></td>
            					<td style="max-width: 75px;" class="copyText"><span class="copy"><?=$coupon['code']?></span> <i class="fa fa-files-o" aria-hidden="true"></i></td>
            ...
            <div class="content content-table">
            		<table class="data-table">
            			...
            			<tbody>
            				...
            				<tr>
            					<td><?=$mycreditcoupon['name']?></td>
            					<td class="copyText"><span class="copy"><?=$coupon['code']?></span> <i class="fa fa-files-o" aria-hidden="true"></i></td>
            					<td><?=$mycreditcoupon['details']?></td>
            					<td><?=$mycreditcoupon['redeemed']?></td>
            					<td></td>
            				</tr>
            				<?php 
        ...
        */
        ...
        <div id="holdweeks-profile" class="w-information">
        	...
        	<div class="content content-table">
    			...
    			<h4>Held Weeks</h4>
        		<table class="ajax-data-table" id="holdweeks" >
        		</table>
        		<div class="pagination">
        			<div class="cnt">
        				<div>
        ...
        <div id="search-profile" class="w-information">
            ...
            <div class="content content-table">
            	...
            	if(isset($histout))
            	{
            	   foreach($histout as $histKey=>$hist)
            	   {
            	       switch($histKey)
            	       {
            	           case 'BonusWeek':
            	   ...
            	   ?>
            		...
            		<table class="data-table">
            			...
            			if(isset($hist))
            			{
                			...
                			?>
                			<tr>
                				<td><?=$histprop['weekId']?></td>
                				<td><?=$histprop['ResortName']?></td>
                				<td><?=$histprop['Price']?></td>
                				<td><?=$histprop['Size']?></td>
