		...
		<ul class="gform_fields">
			...
			<li class="gfield">
				<div class="ginput_container">
					<input type="text" id="user_email_footer" name="user_email_footer" placeholder="Email Address" class="validate" autocomplete="off" required="required"/>
				</div>
			</li>
			<li class="gfield">
				<div class="ginput_container">
					<input id="login_password" id="user_pass_footer" data-id="user_pass_footer" name="user_pass_footer" type="password" placeholder="Password" class="validate" autocomplete="off" required="required"/>
				</div>
			</li>
			<li class="gfield">
