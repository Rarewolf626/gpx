<div class="w-travel-cnt">
	...
	<ul class="w-list">
		<li class="w-item" id="animate1">
			...
			<p>Expand your vacation horizons to hundreds of destinations worldwide right at your fingertips under Resort Locations.</p>
		</li>
		<li class="w-item" id="animate2">
			<img src="<?php echo get_template_directory_uri(); ?>/images/item02.png" alt="">
			<h3>Look Before You Book</h3>
			<p>With GPX you always know we have the week you want before you make a deposit.</p>
		</li>
		<li class="w-item" id="animate3">
			...
			<p>Rent or Exchange weeks allow you to finally explore that bucket list destination. If you don’t see what you’re looking for - we’re here - let us find it for you!</p>
		</li>
	</ul>
</div>