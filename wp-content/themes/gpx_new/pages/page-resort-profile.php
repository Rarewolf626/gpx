...
if ( $resort ) {
    ...
    $sql         = $wpdb->prepare( "SELECT meta_key, meta_value FROM  wp_resorts_meta WHERE ResortID=%s",
                                   $resort->ResortID );
                ...
                <div class="w-list-availables" id="expand_4">
                    <div id="availiblity-calendar-btn">
                        ...
                        <a href="#" style="display: none;"
                           ...
                           id="show-availability" data-month="<?= $dsmonth ?>" data-year="<?= $dsyear ?>"
                           data-resortid="<?= intval( $resort->id ) ?>">
                            <span>Check Pricing & Availability</span>
                            <i class="fa fa-th-large"></i>
                        </a>
                    </div>
