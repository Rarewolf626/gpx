                ...
                <div v-if="loaded" class="transaction-details__status">
                    <div v-if="transaction.cancelled" class="transaction-details__cancelled">
                        ...
                        <div>{{ transaction.cancelled_date }}
                            <span v-if="transaction.cancelled_by && transaction.cancelled_by!='unknown'"> by {{ transaction.cancelled_by }} </span>
                            <span v-if="transaction.cancelled_data.role && transaction.cancelled_data.role!='unknown'">({{ transaction.cancelled_data.role }})</span>
                        </div>
                        <div v-if="transaction.cancelled_data.origin && transaction.cancelled_data.origin !='unknown'">cancelled on {{ transaction.cancelled_data.origin }}</div>
                    </div>
