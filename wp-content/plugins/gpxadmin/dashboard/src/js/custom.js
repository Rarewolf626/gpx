        ...
        function () {
                    ...
                    function (e) {
                        ...
                        jQuery
                            .post(
                                ...
                                function (data) {
                                    if (data.success) {
                                        jQuery('#region-submit').find('i').hide();
                                        jQuery(
                                            '.update-nag')
                                            .removeClass(
                                                'nag-fail')
            ...
            jQuery('html body').on('change', '.switchmetausage',
                function () {
                    ...
                    jQuery.get(
                        'admin-ajax.php?action=gpx_get_switchusage&usage='
                ...
                .on(
                    ...
                    function () {
                        ...
                        if (answer == "Yes")
                            jQuery
                                .get(
                                    'admin-ajax.php?action=gpx_get_switchusage&usage=resort',
                                    function (data) {
                                        jQuery($parent).find(
                                            '.rs-add')
                                            .html(
            ...
            jQuery('html body').on('click', '.resort-list', function (e) {
                        e.preventDefault();
                            ...
                            if (parentVal.length == '') {
                                ...
                                jQuery
                                    .post(
                                        ...
                                        function (data) {
                                            jQuery(topel).find('.insert-resorts').prepend(data.html);
                                        });
                            }
                        }
                    });
            ...
            jQuery('.title_right').on('click', '#third-party-deposit-fees', function (e) {

                var $button = jQuery(this);
                var box = $button.find('i');
                var resort = $button.data('resort');
                jQuery
                    .ajax({
                        url: 'admin-ajax.php?&action=gpx_resort_third_party_deposit_fees',
                        type: 'POST',
                        data: {resort: resort},
                        success: function (data) {
                            if (data.success) {
                                ...
                                if (status) {
                                    ...
                                    box.addClass('fa-check-square').removeClass('fa-square');
                                } else {
                                    $button.addClass('btn-default').removeClass('btn-primary');
                                    box.addClass('fa-square').removeClass('fa-check-square');
                                }
                                $button.data('active', data.status);
