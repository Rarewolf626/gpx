...
?>
                                <table data-toggle="table"
                                             data-url="<?=admin_url("/admin-ajax.php?action=gpx_report_writer_table&id=".$id);?>"
                                             data-cache="false"
              			...
              			<div class="row">
                      		...
                      		<div class="col-xs-6 pull-right" style="text-align: right;">
                      			<?php 
                      			   ...
                      			   {
                      	        ?>
                      	        <button class="btn btn-danger" id="remove-report" data-id="<?=$editreport->id?>">Remove</button>
                      	        <?php    
                      			   }
                      			?>
                      		</div>
						...
						?>
							...
							<div class="row well">
								<div class="col-xs-12">
									...
									<div class="row conditionGroup well" id="cgp<?=$ci?>" data-gp="<?=$ci?>">
										...
										?>
										<select name="condition[<?=$ci?>]" class="condition form-contorl select2" width="100%" style="min-width: 380px;">
										...
										<select name="operator[<?=$ci?>]" class="operator form-control select2">
									...
									<div class="row">
										<button id="newCondition" class="btn btn-primary">+</button>
									</div>
								</div>
							</div>
							<div class="row well" id="emailReport" <?=$showName?>>
								<div class="col-xs-12">
									...
									<select name="emailrepeat" id="emailrepeat" class="form-control select2">
										<option value="0">Select Option</option>
										<?php 
										$options = [
										    'Daily',
									...
									?>
									<textarea id="emailrecipients" name="emailrecipients" class="form-control" placeholder="(email address seperated by comma)"><?=$recipients?></textarea>
								</div>
							</div>
              				<div class="row">
              					<div class="col-xs-12">
