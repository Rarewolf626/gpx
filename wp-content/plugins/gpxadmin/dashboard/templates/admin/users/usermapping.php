<?php
  ...
  $wp_mapuser2oid = $wpdb->get_results($wpdb->prepare("SELECT a.*, b.Room_Type__c FROM `wp_mapuser2oid` a
                                        INNER JOIN wp_owner_interval b on b.unitweek = a.unitweek WHERE a.gpx_user_id = %d", $_GET['id']));
    if($wp_mapuser2oid){
