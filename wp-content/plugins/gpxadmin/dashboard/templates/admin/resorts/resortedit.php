                        ...
                        foreach ($resortDates['fees'] as $repeatableDate => $resortAttribute) {
                            ...
                            <div class="repeatable well">
                                <div class="clone-group">
                                    <i class="fa fa-copy"></i>
                                    <i class="fa fa-times-circle-o" style="margin-left: 10px;" data-type="fees"
                                       data-resortid="<?= $resort->ResortID ?>"></i>
                                </div>
                                <div id="date-select">
                                    <div class="filterRow">
                                ...
                                <div class="two-column-grid">
                                        ...
                                        <form class="resort-edit" data-parsley-validate
                                            ...
                                            <ul class="attribute-list">
                                                ...
                                                <?php foreach ($resortFees as $resortFeeKey => $resortFeeItem): ?>
                                                    <li class="attribute-list-item"
                                                        id="<?= $attributeType ?>-<?= $resortFeeKey ?>"
                                                        data-id="<?= $resortFeeKey ?>"
                                                        data-fee="<?= stripslashes($resortFeeItem) ?>"><?= stripslashes($resortFeeItem) ?>
                                                        <span class="attribute-list-item-remove"><i
                                                                class="fa fa-times-circle-o"></i></span></li>
                                                <?php endforeach; ?>
                                            </ul>
                                            <div class="row form-group attribute-group">
                                                <input type="text" class="form-control form-element new-attribute"
                                                       ...
                                                       data-resort="<?= $resort->ResortID ?>" value="">
                                                <input type="button" class="btn btn-primary insert-attribute"
                                                       value="Add Fee" name="add-attribute"/>
                                            </div>
                                        </form>
                                    </div>
                                    <?php
                                    ...
                                    <div class="edit-resort-group well">
                                        <form class="resort-edit fees-group" data-parsley-validate
                                              class="form-horizontal form-label-left">
                                            <input type="hidden" name="ResortID" value="<?= $resort->ResortID ?>">
                                            <div class="row">
                                                ...
                                                foreach ($resortFees as $resortFeeKey => $resortFeeVal) {
                                                    ...
                                                    <div class="row form-group attribute-group">
                                                        <div class="col-xs-10">
                                                            <input type="text"
                                                                   class="form-control form-element resort-general-edit new-attribute"
                                                                   name="<?= $resortFeeKey ?>" value="<?= $thisAttr; ?>"
                                                                   data-type="<?= $resortFeeKey ?>"
                                                                   data-resort="<?= $resort->ResortID ?>" disabled>
                                                        </div>
                                                        <div class="col-xs-1" style="cursor: pointer"><i
                                                                class="fa fa-lock col-xs-1 resort-lock"
                                                                aria-hidden="true" style="font-size: 20px"></i></div>
                            ...
                            <div class="col-xs-12 col-sm-7">
                                ...
                                <form id="unitTypeadd" data-parsley-validate
                                    ...
                                    <div id="usage-add" class="usage_exclude" data-type="usage">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="name" name="name" required="required"
                                                       class="form-control col-md-7 col-xs-12" value="<?= $uname ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="edit-region">Sleeps
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                ...
                                                <a href="/wp-admin/admin.php?page=gpx-admin-page&gpx-pg=resorts_edit&id=<?= $_GET['id'] ?>"
                                ...
                                <ul>
                                    ...
                                    foreach ($unit_types as $utK => $unit_type) {
                                        ...
                                        <li style="margin-bottom: 15px;">
                                            <a href="/wp-admin/admin.php?page=gpx-admin-page&gpx-pg=resorts_edit&id=<?= $_GET['id'] ?>&unitID=<?= $utK ?>"><?= $unit_type->name ?>
                                                <i class="fa fa-pencil"></i></a>
                                            &nbsp;&nbsp;<a href="#" class="delete-unit" style="color: #f00;"
                                                           data-id="<?= $utK ?>"><i class="fa fa-remove"></i></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
