...
<div class="right_col" role="main">
    ...
    <div class="">
        ...
        <div class="page-title">
            ...
            <div class="title_right text-right">
                <button class="btn btn-danger remove-btn" data-id="<?= $promo->id; ?>" data-action="add_gpx_promo">
                    Remove <?= $promo->Name ?> <i class="fa fa-circle-o-notch fa-spin fa-fw" style="display: none;"></i>
                </button>
                <?php
                ...
                <ul>
                    ...
                    foreach ($master_tied as $mt) {
                        ?>
                        <li><a href="/wp-admin/admin.php?page=gpx-admin-page&gpx-pg=promos_edit&id=<?= $mt->id ?>"
                               target="_blank"><?= $mt->Name ?></a></li>
                        <?php
                    }
                    }
                    ?>
    ...
    <div class="row">
        <div class="col-md-8 col-sm-12 col-md-offset-2">
            <form method="post" action="/wp-admin/admin.php?page=gpx-admin-page&gpx-pg=promos_edit" id="promo-add"
                  data-parsley-validate class="form-horizontal form-label-left well">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="master" id="master"
                            ...
                            foreach ($special_masters as $special_master) {
                                ...
                                ?>
                                <option
                                    value="<?= $special_master->id ?>" <?= $selected ?>><?= $special_master->Name ?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bookingFunnel">Booking Funnel <span
                            class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="bookingFunnel" id="bookingFunnel" class="form-control col-md-7 col-xs-12">
                            <?php
                            $activeopts = ['No' => 'coupon', 'Yes' => 'promo'];
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="Name" name="Name" required="required"
                               ...
                               value="<?= stripslashes($promo->Name); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Name" id="promoorcoupon">
                        <?= $type ?> <?php if ($type == 'Coupon') echo 'Code'; else echo 'Slug'; ?> <span
                            class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="Slug" name="Slug" required="required"
                               class="form-control col-md-7 col-xs-12" value="<?= $promo->Slug ?>"><br>
                        <a href="<?= get_permalink('229') . $promo->Slug ?>" class=""
                           target="_blank"><?= get_permalink('229') . $promo->Slug ?></a>
                    </div>
                </div>
                <div
                    class="form-group promo two4one-hide" <?php if ($type == 'Coupon') echo 'style="display: none;"'; ?>>
                ...
                <div class="form-group promo two4one-hide" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="metaGACode" name="metaGACode" class="form-control col-md-7 col-xs-12"
                               value="<?= $promometa->GACode ?>">
                    </div>
                </div>
                <div class="form-group promo two4one-hide" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="metaIcon" name="metaIcon"
                               class="form-control fapicker col-md-7 col-xs-12" value="<?= $promometa->icon ?>">
                    </div>
                </div>
                <div class="form-group promo two4one-hide" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="metaDesc" name="metaDesc"
                                  class="form-control col-md-7 col-xs-12"><?= $promometa->desc ?></textarea>
                    </div>
                </div>
                <div class="form-group promo two4one-hide" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="metaHighlight" name="metaHighlight" class="form-control col-md-7 col-xs-12">
                            <option></option>
                            <?php
                            $activeopts = ['Highlighted', 'Prevent Highlighting'];
                ...
                <div class="form-group promo two4one-hide" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="metaSlash" name="metaSlash" class="form-control col-md-7 col-xs-12">
                            <option></option>
                            <?php
                            $activeopts = ['Default', 'Force Slash', 'No Slash'];
                            foreach ($activeopts as $optvalue) {
                                $selected = '';
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="metaType"><?= $type; ?> Type <span
                            class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="metaType" name="metaType" required="required"
                            ...
                            <?php
                            $activeopts = [
                                ['type' => 'all', 'val' => 'Pct Off'],
                                ['type' => 'all', 'val' => 'Dollar Off'],
                                ['type' => 'all', 'val' => 'Set Amt'],
                                ['type' => 'Coupon', 'val' => 'BOGO'],
                                ['type' => 'Coupon', 'val' => 'BOGOH'],
                                ['type' => 'Coupon', 'val' => 'Auto Create Coupon Template -- Pct Off'],
                                ['type' => 'Coupon', 'val' => 'Auto Create Coupon Template -- Dollar Off'],
                                ['type' => 'Coupon', 'val' => 'Auto Create Coupon Template -- Set Amt'],
                                ['type' => 'all', 'val' => '2 for 1 Deposit'],
                            ];
                            foreach ($activeopts as $optvalue) {
                                $selected = '';
                ...
                <div class="form-group two4one-hide" id="acCoupon">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="checkbox" id="acCouponField" name="acCoupon"
                               value="1" <?php if (isset($promometa->acCoupon) && $promometa->acCoupon == 1) echo 'checked' ?>>
                    </div>
                </div>
                ...
                <div class="form-group two4one-hide">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Amount"><?= $type ?> Amount <span
                            class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="Amount" name="Amount" required="required"
                               class="form-control col-md-7 col-xs-12"
                               value="<?= $promoAmount; ?>" <?= $amountDisabled ?>>
                    </div>
                </div>
                <div class="form-group two4one-hide">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                ...
                <div class="form-group coupon two4one-hide">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="metaMaxValue" name="metaMaxValue" class="form-control col-md-7 col-xs-12"
                               value="<?= $promometa->maxValue; ?>">
                    </div>
                </div>
                <div class="form-group two4one-hide">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Name">Transaction Type <span
                            class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="metaTransactionType" class="form-control col-md-7 col-xs-12" required="required"
                                id="metaTransactionType">
                            <option
                                value="any"
                                <?= in_array('any', Arr::wrap($promometa->transactionType ?? [])) ? 'selected' : '' ?>
                            >
                                Any
                            </option>
                            <option
                                value="ExchangeWeek"
                                <?= in_array('ExchangeWeek', Arr::wrap($promometa->transactionType ?? [])) ? 'selected' : '' ?>
                            >
                                Exchange
                            </option>
                            <option
                                value="BonusWeek"
                                <?= in_array('BonusWeek', Arr::wrap($promometa->transactionType ?? [])) ? 'selected' : '' ?>
                            >
                                Rental/Bonus
                            </option>
                            <option
                                value="upsell"
                                <?= in_array('upsell', Arr::wrap($promometa->transactionType ?? [])) ? 'selected' : '' ?>
                            >
                                Upsell Only
                            </option>
                        </select>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="metaUpsellOptions">
                        Upsell Options
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="checkbox">
                            <label>
                                <input
                                    ...
                                    value="CPO"
                                    <?= (in_array('CPO', Arr::wrap($promometa->upsellOptions ?? []))) ? 'checked' : '' ?>
                                />
                        ...
                        <div class="checkbox">
                            <label>
                                <input
                                    ...
                                    name="metaUpsellOptions[]"
                                    value="Upgrade"
                                    <?= (in_array('Upgrade', Arr::wrap($promometa->upsellOptions ?? []))) ? 'checked' : '' ?>
                                />
                                Upgrade
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input
                                    ...
                                    name="metaUpsellOptions[]"
                                    value="Guest Fees"
                                    <?= (in_array('Guest Fees', Arr::wrap($promometa->upsellOptions ?? []))) ? 'checked' : '' ?>
                                />
                                Guest Fees
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input
                                    ...
                                    <?= (in_array('Extension Fees', Arr::wrap($promometa->upsellOptions ?? []))) ? 'checked' : '' ?>
                                />
                                Extension Fees
                            </label>
                        </div>
            ...
            <?php
                ...
                <div class="clone-group well">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-11">
                            <select name="metaUsage[]" class="form-control col-md-7 col-xs-12 switchmetausage">
                                ...
                                <option value="customer" <?php if ($usage == 'customer') echo 'selected' ?>>Customer
                                </option>
                            </select>
                        </div>
                    ...
                    if (isset($promometa->usage) && $promometa->usage == 'customer') {
                        ?>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="metaCustomerResortSpecific">Resort
                                Specific
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="metaCustomerResortSpecific" id="metaCustomerResortSpecific"
                                        class="form-control col-md-7 col-xs-12 metaCustomerResortSpecific">
                                    <option></option>
                                    <option<?php if ($promometa->metaCustomerResortSpecific == "Yes") echo ' selected'; ?>>
                                        Yes
                                    </option>
                                    <option<?php if ($promometa->metaCustomerResortSpecific == "No") echo ' selected'; ?>>
                                        No
                                    </option>
                                </select>
                            </div>
                            ...
                            if (isset($usage_regionName) && !empty($usage_resortNames)) {
                                ...
                                <div class="row form-group parent-delete">
                                    <div class="col-md-7 col-xs-11">
                                        <input type="hidden" name="usage_parent[]"
                                               value="<?= $promometa->usage_region ?>">
                                        <strong>
                                            <?php
                                ...
                                <div class="row">
                                    <div class="col-xs-12 pull-right">
                                        <a href="#" class="btn btn-primary newResort" data-type="#switchusage">Add
                                            Resort</a>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="metaResortBlackoutStart[]"
                                               class="form-control rbodatepicker col-md-7 col-xs-12"
                                               value="<?= date('m/d/Y', strtotime($resortBlackout->start)) ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="metaResortBlackoutEnd[]"
                                               class="form-control rbodatepicker col-md-7 col-xs-12"
                                               value="<?= date('m/d/Y', strtotime($resortBlackout->end)) ?>">
                                    </div>
                                </div>
                            </div>
                            <input class="metaResortBlackoutResorts" name="metaResortBlackoutResorts[]"
                                   value="<?= implode(",", $resortBlackout->resorts) ?>" type="hidden">
                            <?php
                        }
                    } else {
                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="metaResortTravelStart[]"
                                               class="form-control rbodatepicker col-md-7 col-xs-12"
                                               value="<?= date('m/d/Y', strtotime($resortTravel->start)) ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="metaResortTravelEnd[]"
                                               class="form-control rbodatepicker col-md-7 col-xs-12"
                                               value="<?= date('m/d/Y', strtotime($resortTravel->end)) ?>">
                                    </div>
                                </div>
                            </div>
                            <input class="metaResortTravelResorts" name="metaResortTravelResorts[]"
                                   value="<?= implode(",", $resortTravel->resorts) ?>" type="hidden">
                            <?php
                        }
                    } else {
                        ?>
                    ...
                    <div class="form-group two4one-hide">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-11">
                            <select name="metaExclusions[]" id="switchexclusions"
                                ...
                                <option></option>
                                <option value="region" <?php if ($exclusions == 'region') echo 'selected' ?>>Region
                                </option>
                                <option value="resort" <?php if ($exclusions == 'resort') echo 'selected' ?>>Resort
                                </option>
                                <option value="home-resort" <?php if ($exclusions == 'home-resort') echo 'selected' ?>>
                                    Home Resort
                                </option>
                                <option value="dae" <?php if ($exclusions == 'dae') echo 'selected' ?>>DAE Inventory
                                </option>
                            </select>
                        </div>
                        <div class="col-xs-1 add-new">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            if (isset($exclude_regionName)) {
                                ...
                                <div class="row form-group">
                                    <div class="col-md-7 col-xs-11">
                                        <input type="hidden" name="exclude_parent[]"
                                               value="<?= $promometa->exclude_region ?>">
                                        <strong>
                                            <?php
                                            if (isset($parent)) echo $parent . " &gt; ";
                                ...
                                <div class="row">
                                    <div class="col-xs-12 pull-right">
                                        <a href="#" data-type="#switchexclusions" class="btn btn-primary newResort">Add
                                            Resort</a>
                                    </div>
                                </div>
                                <?php
            ...
            ?>
                <div class="well promo exclusiveWeeksBox">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="form-control" name="exclusiveWeeks"
                                      id="exclusiveWeeks"><?php if (isset($promometa->exclusiveWeeks)) echo $promometa->exclusiveWeeks; ?></textarea>
                            <span style="font-size: 10px;">Week ID separated by comma</span>
                        </div>
                    </div>
                </div>
                <div class="form-group coupon two4one-hide">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="metaStacking">Allow Stacking Discount
                        <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="metaStacking" id="metaStacking" class="form-control col-md-7 col-xs-12"
                                required="required">
                            <?php
                            $activeopts = ['No' => 'No', 'Yes' => 'Yes'];
                            foreach ($activeopts as $optkey => $optvalue) {
                ...
                <div
                    class="form-group coupon two4one-hide" <?php if ($type == 'Promo') echo 'style="display: none;"'; ?>>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="metaMaxCoupon" name="metaMaxCoupon"
                               class="form-control col-md-7 col-xs-12"
                               value="<?php if (isset($promometa->maxCoupon)) echo $promometa->maxCoupon; ?>">
                    </div>
                </div>
                <div class="well">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="StartDate">Start Date <span
                                class="dateTextSwitch">(Available for Viewing)</span><span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="StartDate" name="StartDate" required="required"
                                   class="form-control datepicker col-md-7 col-xs-12"
                                   value="<?= date('m/d/y', strtotime($promo->StartDate)); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="EndDate">End Date <span
                                class="dateTextSwitch">(Available for Viewing)</span><span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="EndDate" name="EndDate" required="required"
                                   class="form-control datepicker col-md-7 col-xs-12"
                                   value="<?= date('m/d/y', strtotime($promo->EndDate)); ?>">
                        </div>
                    </div>
                </div>
                <div class="well two4one-hide">
                    <div class="form-group two4one-hide">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="metaFlashStart">Flash Sale Start
                            Time
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="metaFlashStart" name="metaFlashStart"
                                   class="form-control timepicker col-md-7 col-xs-12"
                                   value="<?= $promometa->flashStart ?>">
                        </div>
                    </div>
                    <div class="form-group two4one-hide">
                ...
                <div class="well two4one-hide">
                    <div class="form-group two4one-hide">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="metaBookStartDate" name="metaBookStartDate"
                                   class="form-control datepicker col-md-7 col-xs-12"
                                   value="<?= $promometa->bookStartDate; ?>">
                        </div>
                    </div>
                    <div class="form-group two4one-hide">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="metaBookEndDate" name="metaBookEndDate"
                                   class="form-control datepicker col-md-7 col-xs-12"
                                   value="<?= $promometa->bookEndDate; ?>">
                        </div>
                    </div>
                </div>
                <div class="well two4one-hide">
                    <div class="form-group two4one-hide">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="metaTravelStartDate">Travel Start
                            Date
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="metaTravelStartDate" name="metaTravelStartDate"
                                   class="form-control datepicker col-md-7 col-xs-12"
                                   value="<?= $promometa->travelStartDate; ?>">
                        </div>
                    </div>
                    <div class="form-group two4one-hide">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="metaTravelEndDate" name="metaTravelEndDate"
                                   class="form-control datepicker col-md-7 col-xs-12"
                                   value="<?= $promometa->travelEndDate; ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group two4one-hide">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="metaLeadTimeMin">Lead Time Minimum
                        (days)
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="metaLeadTimeMin" name="metaLeadTimeMin"
                               class="form-control col-md-7 col-xs-12" value="<?= $promometa->leadTimeMin; ?>">
                    </div>
                </div>
                <div class="form-group two4one-hide">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="metaLeadTimeMax">Lead Time Maximum
                        (days)
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="metaLeadTimeMax" name="metaLeadTimeMax"
                               class="form-control col-md-7 col-xs-12" value="<?= $promometa->leadTimeMax; ?>">
                    </div>
                </div>
                <div class="form-group promo two4one-hide" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="metaTerms" name="metaTerms"
                                  class="form-control col-md-7 col-xs-12"><?= $promometa->terms ?></textarea>
                    </div>
                </div>
