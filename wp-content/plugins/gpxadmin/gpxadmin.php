...
defined('GPXADMIN_VERSION') or define('GPXADMIN_VERSION', '2.23');
...
if (is_admin()) {
    if (gpx_request('page') == 'gpx-admin-page') {
        add_action('admin_enqueue_scripts', function () {
            ...
            wp_enqueue_style('bootstrap_table_filter', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.18.0/extensions/filter-control/bootstrap-table-filter-control.min.css', ['bootstrap_table'], '1.18.0', true);
            ...
            wp_enqueue_script('parsley', 'https://cdnjs.cloudflare.com/ajax/libs/parsley.js/2.9.2/parsley.min.js', array(), '2.9.2', true);
            wp_enqueue_script('select2', 'https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js', array('jquery'), '4.0.13', true);
            wp_enqueue_script('htmx', 'https://cdnjs.cloudflare.com/ajax/libs/htmx/1.9.6/htmx.min.js', array(), '1.9.6', ['strategy' => 'defer', 'in_footer' => true]);
            ...
            wp_register_script('jquery_ui', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js', array('jquery'), '1.12.1', true);
            wp_enqueue_script("jquery-ui-draggable");
            wp_enqueue_script("jquery-ui-sortable");
            wp_enqueue_script('timepicker', '//cdnjs.cloudflare.com/ajax/libs/timepicker/1.3.5/jquery.timepicker.min.js', array('jquery_ui'), '1.3.5', true);
            wp_enqueue_script('bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', array('jquery'), '3.3.7', false);
            wp_enqueue_script('bootstrap_table', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.18.0/bootstrap-table.min.js', array('bootstrap'), '1.18.0', true);
            wp_enqueue_script('bootstrap_table_filter', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.18.0/extensions/filter-control/bootstrap-table-filter-control.min.js', array('bootstrap_table'), '1.18.0', true);
            wp_enqueue_script('bootstrap_table_export', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.18.0/extensions/export/bootstrap-table-export.min.js', array('bootstrap_table'), '1.18.0', true);
            wp_enqueue_script('bootstrap_tableexport', '//rawgit.com/hhurz/tableExport.jquery.plugin/master/tableExport.js', array('bootstrap_table_export'), true);
//            wp_enqueue_script('fastclick_jquery', GPXADMIN_PLUGIN_URI . '/vendors/fastclick/lib/fastclick.js', array('bootstrap'), null, true);
            wp_enqueue_script('bootstrap_select', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/js/bootstrap-select.min.js', array('bootstrap'), '1.12.4', true);
            wp_enqueue_script('bootstrap_multiselect', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.13/js/bootstrap-multiselect.min.js', array('bootstrap'), '0.9.13', true);
            wp_enqueue_script('javascript_cookie', '//cdnjs.cloudflare.com/ajax/libs/js-cookie/2.1.3/js.cookie.min.js', array('bootstrap'), '2.1.3', true);
            wp_enqueue_script('moment', 'https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.4/moment.min.js', array('bootstrap'), '2.29.4', true);
            wp_enqueue_script('daterangepicker', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/2.1.27/daterangepicker.js', array('moment', 'jquery', 'bootstrap'), '2.1.27', true);
            wp_enqueue_script('fontawesome_iconpicker', GPXADMIN_PLUGIN_URI . '/vendors/fontawesome-iconpicker/js/fontawesome-iconpicker.min.js', array('bootstrap'), null, true);
            wp_enqueue_script('nprogress', GPXADMIN_PLUGIN_URI . '/vendors/nprogress/nprogress.js', array('bootstrap', 'jquery'), null, true);
            wp_enqueue_script('wysiwyg_jquery', GPXADMIN_PLUGIN_URI . '/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js', array('bootstrap'), null, true);
            wp_enqueue_script('hotkeys_jquery', GPXADMIN_PLUGIN_URI . '/vendors/jquery.hotkeys/jquery.hotkeys.js', array('jquery'), null, true);
            wp_enqueue_script('prettify', GPXADMIN_PLUGIN_URI . '/vendors/google-code-prettify/src/prettify.js', array('bootstrap', 'jquery'), null, true);
            wp_enqueue_script('lzstring', GPXADMIN_PLUGIN_URI . '/vendors/lzstring/lz-string.min.js', array('bootstrap'), GPXADMIN_VERSION, true);
            wp_enqueue_script('custom_jquery', GPXADMIN_PLUGIN_URI . '/build/js/custom.js', array('bootstrap', 'jquery', 'axios'), GPXADMIN_VERSION, true);
        });
...
require_once __DIR__ . '/gpxadmin/htmx.php';
