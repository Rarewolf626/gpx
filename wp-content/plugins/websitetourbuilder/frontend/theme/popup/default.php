...
?>
  <?php /*?>  <div id="<?php echo $jfwstbdiv[$i]['textarea']; ?>" style="display: none;"><?php */?>
    <div id="jfwstb_<?php echo $i; ?>" style="display: none;">
        ...
        <?php if(isset($jfwstbdiv[$i]['textarea'])){ ?>
        <div class="tooltipText" style="white-space: pre-line;"><?php echo html_entity_decode($jfwstbdiv[$i]['textarea']); ?></div>
        <?php } else {
            echo '<div class="tooltipText" style="white-space: pre-line;"></div>';    
        } ?>
                <?php
