	...
	static function _global_head()
	{
		...
		jQuery(function($)
		{
			...
			$('[class*=docopy-]').click(function(e)
			{
                ...
                //replace the current editor function
                total_steps_editor++;                
                var current_ind = total_steps_editor;                
                the_clone = add_new_editor(the_clone, current_ind, the_clone.find('textarea').attr('name'));
				...
				else
				{
                    ...
                    init_tinymce('mceEditor-'+current_ind);
				}
            ...
            // Create a editor for new step
            
            function add_new_editor(the_clone, t_i, name)
            {
            	var html = '';
            	var new_selector_name = 'mceEditor-'+t_i;
            	html += '<div id="wp-'+new_selector_name+'-wrap" class="wp-core-ui wp-editor-wrap html-active">';
            		html += '<div id="wp-'+new_selector_name+'-editor-tools" class="wp-editor-tools hide-if-no-js">';
            			html += '<div id="wp-'+new_selector_name+'-media-buttons" class="wp-media-buttons">';
            				html += '<button type="button" class="button insert-media add_media" data-editor="'+new_selector_name+'"><span class="wp-media-buttons-icon"></span> Add Media</button>';
            			html += '</div>';
            			html += '<div class="wp-editor-tabs">';
            				html += '<button type="button" id="'+new_selector_name+'-tmce" class="wp-switch-editor switch-tmce" data-wp-editor-id="'+new_selector_name+'">Visual</button>';
            				html += '<button type="button" id="'+new_selector_name+'-html" class="wp-switch-editor switch-html" data-wp-editor-id="'+new_selector_name+'">Text</button>';
            			html += '</div>';
            		html += '</div>';
            		html += '<div id="wp-'+new_selector_name+'-editor-container" class="wp-editor-container">';
            			html += '<div id="qt_'+new_selector_name+'_toolbar" class="quicktags-toolbar"></div>';
            			html += '<textarea class="wp-editor-area" rows="20" autocomplete="off" cols="40" name="'+name+'" id="'+new_selector_name+'"></textarea>';
            		html += '</div>';
            	html += '</div>';
            	the_clone.find('.editor_wrap').replaceWith(html);
                
                return the_clone;
                
            }	
            
            // calling tinyMCE initialization
            
            function init_tinymce(new_selector_name){
                
                tinyMCEPreInit.mceInit[new_selector_name] = {theme:"modern",skin:"lightgray",language:"en",formats:{alignleft: [{selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: {textAlign:"left"}},{selector: "img,table,dl.wp-caption", classes: "alignleft"}],aligncenter: [{selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: {textAlign:"center"}},{selector: "img,table,dl.wp-caption", classes: "aligncenter"}],alignright: [{selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: {textAlign:"right"}},{selector: "img,table,dl.wp-caption", classes: "alignright"}],strikethrough: {inline: "del"}},relative_urls:false,remove_script_host:false,convert_urls:false,browser_spellcheck:true,fix_list_elements:true,entities:"38,amp,60,lt,62,gt",entity_encoding:"raw",keep_styles:false,cache_suffix:"wp-mce-4205-20150910",preview_styles:"font-family font-size font-weight font-style text-decoration text-transform",end_container_on_empty_block:true,wpeditimage_disable_captions:false,wpeditimage_html5_captions:true,plugins:"charmap,colorpicker,hr,lists,media,paste,tabfocus,textcolor,fullscreen,wordpress,wpautoresize,wpeditimage,wpemoji,wpgallery,wplink,wpdialogs,wptextpattern,wpview",content_css:"http://192.168.1.107/wordpress-4.3.1/wp-includes/css/dashicons.min.css?ver=4.3.1,http://192.168.1.107/wordpress-4.3.1/wp-includes/js/tinymce/skins/wordpress/wp-content.css?ver=4.3.1,https://fonts.googleapis.com/css?family=Noto+Sans%3A400italic%2C700italic%2C400%2C700%7CNoto+Serif%3A400italic%2C700italic%2C400%2C700%7CInconsolata%3A400%2C700&subset=latin%2Clatin-ext,http://192.168.1.107/wordpress-4.3.1/wp-content/themes/twentyfifteen/css/editor-style.css,http://192.168.1.107/wordpress-4.3.1/wp-content/themes/twentyfifteen/genericons/genericons.css",selector:"#"+new_selector_name,resize:"vertical",menubar:false,wpautop:true,indent:false,toolbar1:"bold,italic,strikethrough,bullist,numlist,blockquote,hr,alignleft,aligncenter,alignright,link,unlink,wp_more,spellchecker,fullscreen,wp_adv",toolbar2:"formatselect,underline,alignjustify,forecolor,pastetext,removeformat,charmap,outdent,indent,undo,redo,wp_help",toolbar3:"",toolbar4:"",tabfocus_elements:":prev,:next",body_class:new_selector_name+" post-type-post post-status-publish post-format-standard locale-en-us"};
            	tinyMCEPreInit.qtInit[new_selector_name] = {id:new_selector_name,buttons:"strong,em,link,block,del,ins,img,ul,ol,li,code,more,close"};
            	console.log(tinyMCEPreInit);
            	var init, id, $wrap;
            	id = new_selector_name;
